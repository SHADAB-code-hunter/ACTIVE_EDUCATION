...
public class PayU_Money_Activity extends Activity {
        ...
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (jsonObject.has(SdkConstants.STATUS)) {
                        ...
                        if (status != null || status.equals("1")) {
                            ...
                            PayUmoneySdkInitilizer.startPaymentActivityForResult(PayU_Money_Activity.this, paymentParam);
                        } else {
                            Toast.makeText(PayU_Money_Activity.this,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NoConnectionError) {
                    Toast.makeText(PayU_Money_Activity.this,
                            PayU_Money_Activity.this.getString(R.string.connect_to_internet),
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(PayU_Money_Activity.this,
                            error.getMessage(),
