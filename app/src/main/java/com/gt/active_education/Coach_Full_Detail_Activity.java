...
import static utilities.UrlEndpoints.MAIN_URL_COACH_FUL_DETAIL;
...
public class Coach_Full_Detail_Activity extends AppCompatActivity implements View.OnClickListener {
        ...
        id_linear_change_course.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                        ...
                        public void onfinal_list(JSONObject data, String choose_class) {
                            try {
                                ...
                                if(availschool_class!=null)
                                    availschool_class.cancel();
                                JSONObject jsonObject=  Coach_Full_Detail_Activity.this.jsonObject3.put("course_id",""+data.getString("id"));
                    ...
                    },Coach_Full_Detail_Activity.this,MAIN_URL_COACH_FUL_DETAIL+ jsonObject3.getString("c_id"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void get_deatil_asynch(JSONObject jsonObject3) {
        try {
            ...
            new New_Asynch_MAp(new New_Asynch_MAp.JOBJ_LISTENER() {
                ...
                public void on_listener(JSONObject jsonobject, String str_key) {
                    try {
                        ...
                        certifiacte_adapter=new Gallery_Dapter_school_json(Coach_Full_Detail_Activity.this,jsonobject.getJSONArray("certificate"));
                        id_rv_certficate.setAdapter(certifiacte_adapter);
                        banner_adapter_jSon=new Banner_Adapter_JSon(Coach_Full_Detail_Activity.this,jsonobject.getJSONArray("banner"),"banner");
                        id_collge_banner.setAdapter(banner_adapter_jSon);
                        id_rv_facility.setAdapter(new Facility_Adapter_JSon(Coach_Full_Detail_Activity.this,jsonobject.getJSONArray("facility")));
                        id_gallery_recycler_view.setAdapter(new Gallery_Dapter_school_json(Coach_Full_Detail_Activity.this,jsonobject.getJSONArray("gallery")));
            ...
            }, App_Static_Method.toMap(jsonObject3),MAIN_URL_COACH_FUL_DETAIL,"data").execute();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void get_detail_school(JSONObject jsonObject) {
        ...
        try {
          ...
          //  duration.append(jsonObject.getString("class_name"));
            ...
            id_fees1.setText(jsonObject.getString("fee")+"Rs / Year ");
      ...
      //  String brouchure_doewnload="http://activeeduindia.com/admin/webservices/downloadBrochure.php?type=1&brochure="+str_brouchuer;
        ...
        if (brouchure_doewnload!=null) {
            if (isSubstring("http://", brouchure_doewnload)) {
                ...
                Intent intent = new Intent(Coach_Full_Detail_Activity.this, Website_Activity.class);
            ...
            Toast.makeText(Coach_Full_Detail_Activity.this, "Link Not Found !!!!", Toast.LENGTH_SHORT).show();
