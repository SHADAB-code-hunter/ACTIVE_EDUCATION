...
import fragment.Guest_SignUp_FRG;
...
public class Signup_Guest_Activity extends AppCompatActivity implements View.OnClickListener {
...
*/
            ...
            exp_iti.setVisibility(View.GONE);
            exp_uni.setVisibility(View.GONE);
            exp_coach.setVisibility(View.GONE);
            exp_school.setVisibility(View.GONE);
            exp_train.setVisibility(View.GONE);
            id_school.setVisibility(View.GONE);
            id_college.setVisibility(View.GONE);
