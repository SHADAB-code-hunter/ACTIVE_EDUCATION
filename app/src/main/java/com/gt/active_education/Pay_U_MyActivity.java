...
public class Pay_U_MyActivity extends Activity {
...
/* String salt = "";
        ...
        PayUmoneySdkInitilizer.startPaymentActivityForResult(Pay_U_MyActivity.this, paymentParam);*//*
        ...
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (jsonObject.has(SdkConstants.STATUS)) {
                        ...
                        if (status != null || status.equals("1")) {
                            ...
                            Toast.makeText(Pay_U_MyActivity.this,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NoConnectionError) {
                    Toast.makeText(Pay_U_MyActivity.this,
                            Pay_U_MyActivity.this.getString(R.string.connect_to_internet),
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Pay_U_MyActivity.this,
                            error.getMessage(),
