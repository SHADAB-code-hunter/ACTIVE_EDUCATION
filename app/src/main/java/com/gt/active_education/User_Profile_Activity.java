...
import adapter.User_Profile_Adapter;
...
public class User_Profile_Activity extends AppCompatActivity implements Log_Out_Listener, View.OnClickListener, JOBJ_Listener,Imager_Picker_Activity.ImageAttachmentListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_title=(TextView)findViewById(R.id.id_title);id_title.setText("User Profile");
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            startActivity(new Intent( User_Profile_Activity.this,DashBoard_Activity.class));
                            finish();
    ...
    private void initUI() {
        ...
        User_Profile_Adapter agentProfileVpAdpter=new User_Profile_Adapter(getSupportFragmentManager());
...
//                        .selectedIcon(getResources().getDrawable(R.drawable.ic_eighth))
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.id_frm:
                 /* image pick*/
                permission_check(101, User_Profile_Activity.this);
                imagePicker =new Imager_Picker_Activity(User_Profile_Activity.this);

                if (Build.VERSION.SDK_INT >= 23)
                    imagePicker.imagepicker(1);
                else
                    App_Static_Method.lower_camera_call_act(User_Profile_Activity.this);
                break;
        }
    }
    @Override
...
//        Log.d("dataedpack",data.toString());
    ...
    private void send_serve_image(String stringImage) {
       ...
       // Log.d("fhghfghgf",""+map);
        map.put("type",session_type().get("type"));
      //  map.put("mobile",""+(session_type().get("mobile")));
        map.put("token",session_type().get("token"));
        map.put("filename",(session_type().get("mobile")+".png"));

        map.put("image",stringImage);
        Log.d("mmt_ttgtg",""+map.toString());
            ...
            public void obn_obj_find(JSONObject jsonObject) {
                ...
                try {
                    ...
                    if (jsonObject.getInt("msg")==1) {
                        ...
                        Toast.makeText(User_Profile_Activity.this, "Profile Picture Not Updated", Toast.LENGTH_SHORT).show();
        ...
        }, UrlEndpoints.SEND_PROFILE_UPDATE+"mobile="+(session_type().get("mobile")),map).execute();
    ...
    public void onLJsonLoaded_new(JSONObject jsonObject) {
        try {
            ...
            Picasso.with(User_Profile_Activity.this)
                    .load(GET_PROFILE+"/profile/"+(jsonObject1).getString("image"))
