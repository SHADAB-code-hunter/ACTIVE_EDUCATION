...
public class RubberIndicator extends RelativeLayout {
    ...
    private static final int LARGE_CIRCLE_RADIUS = 15;
    private static final int OUTER_CIRCLE_RADIUS = 30;

    private static final int BEZIER_CURVE_ANCHOR_DISTANCE = 10;
