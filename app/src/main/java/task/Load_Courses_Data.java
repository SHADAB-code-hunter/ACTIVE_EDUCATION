...
public class Load_Courses_Data extends AsyncTask<Void, Void, List<Common_Pojo>> {
    private Upcoming_List_LoadedListener myComponent;
    private VolleySingleton volleySingleton;
    private RequestQueue requestQueue;
    private String url;

    public Load_Courses_Data(Upcoming_List_LoadedListener myComponent,String url) {
        this.url=url;
