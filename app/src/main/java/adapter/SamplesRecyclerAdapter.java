...
import com.gt.active_education.Sample;
import com.gt.active_education.SharedElementActivity;
import com.gt.active_education.databinding.RowSampleBinding;
import com.gt.active_education.TransitionHelper;
...
public class SamplesRecyclerAdapter extends RecyclerView.Adapter<SamplesRecyclerAdapter.SamplesViewHolder> {
    ...
    public SamplesRecyclerAdapter(DashBoard_Activity activity,List<Sample> samples) {
