...
public class Uni_adapter extends RecyclerView.Adapter<Uni_adapter.MovieViewHolder> {
    ...
    public Uni_adapter(Activity _activity, JSONArray data) {
    ...
    public void onBindViewHolder(MovieViewHolder holder, final int position) {
        ...
        try {
           ...
           // Toast.makeText(_activity, ""+jsonObject.getString("c_image"), Toast.LENGTH_SHORT).show();
            ...
            holder.tv_title.setText(jsonObject.getString("u_name"));

            if(jsonObject.has("u_image"))
            Glide.with(_activity)
                    .load(jsonObject.getString("u_image"))
            ...
            if(jsonObject.has("u_course")) {
                holder.tv_course.setText("Course : " +jsonObject.getString("u_course"));
            }
            if(jsonObject.has("branch_fee")) {
                holder.tv_rating.setText("Course Fee : " +jsonObject.getString("branch_fee"));
            }
            if(jsonObject.has("u_website")) {
                 _website=jsonObject.getString("u_website");
            }
            if(jsonObject.has("discount")) {
            ...
            if(jsonObject.has("affiliation")) {
             ...
             if(jsonObject.has("u_branch")) {
               holder.tv_year.setText("Branch : " +jsonObject.getString("u_branch"));
            }
