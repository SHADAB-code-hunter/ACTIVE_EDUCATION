...
public class ITI_Top_adapter extends RecyclerView.Adapter<ITI_Top_adapter.MovieViewHolder> {
    ...
    public ITI_Top_adapter(Activity _activity, JSONArray data) {
    ...
    public void onBindViewHolder(MovieViewHolder holder, final int position) {
        ...
        try {
            ...
            if(jsonObject.has("i_name"))
                holder.tv_title.setText(jsonObject.getString("i_name"));

            if(jsonObject.has("i_image"))
                Glide.with(_activity)
                        .load(jsonObject.getString("i_image"))
            ...
            if(jsonObject.has("t_course")) {
                holder.tv_course.setText("Trade : " +jsonObject.getString("t_course"));
            }
            if(jsonObject.has("trade_fee")) {
                holder.tv_rating.setText("Trade Fee : " +jsonObject.getString("trade_fee")+"/-");
            }
            if(jsonObject.has("branch_fee")) {
                holder.tv_rating.setText("Trade Fee : " +jsonObject.getString("branch_fee")+"/-");
            }
            if(jsonObject.has("i_website")) {
                _website=jsonObject.getString("i_website");
            }
            if(jsonObject.has("discount")) {
            ...
            if(jsonObject.has("i_type")) {
                holder.tv_year.setText("Mode : " +jsonObject.getString("i_type"));
            }
