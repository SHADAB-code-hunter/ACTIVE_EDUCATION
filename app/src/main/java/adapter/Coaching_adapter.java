...
public class Coaching_adapter extends RecyclerView.Adapter<Coaching_adapter.MovieViewHolder> {
    ...
    public Coaching_adapter(Activity _activity, JSONArray data) {
    ...
    public void onBindViewHolder(MovieViewHolder holder, final int position) {
        ...
        try {
           ...
           /* if(jsonObject.has("c_address")) {
               holder.tv_year.setText(jsonObject.getString("c_address"));
            }*/
            if(jsonObject.has("s_name")) {
                holder.tv_quality.setText("Subject : "+jsonObject.getString("s_name"));
            }
