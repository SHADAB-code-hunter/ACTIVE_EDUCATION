...
public class ITI_adapter extends RecyclerView.Adapter<ITI_adapter.MovieViewHolder> {
    ...
    public ITI_adapter(Activity _activity, JSONArray data) {
        ...
        try {
           ...
           // Toast.makeText(_activity, ""+jsonObject.getString("c_image"), Toast.LENGTH_SHORT).show();
            ...
            if(jsonObject.has("c_course")) {
                holder.tv_course.setText("Trade : " +jsonObject.getString("c_course"));
            }
            ...
            if(jsonObject.has("c_type")) {
                holder.tv_year.setText("Mode : " +jsonObject.getString("c_type"));
            }
