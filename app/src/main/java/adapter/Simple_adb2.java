...
public class Simple_adb2 extends RecyclerView.Adapter<Simple_adb2.MyViewHolder> {

    private List<String> list_item;
    public Call_newDialog_Listener listener;
    public List<String> arrayList_id;

    public Simple_adb2(List<String> list, Call_newDialog_Listener listener) {
    ...
    @Override
    public Simple_adb2.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a layout
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.list_item_search, null);

        Simple_adb2.MyViewHolder myViewHolder = new Simple_adb2.MyViewHolder(view);
        return myViewHolder;
    }

    // Called by RecyclerView to display the data at the specified position.
    @Override
    public void onBindViewHolder(final Simple_adb2.MyViewHolder viewHolder, final int position) {
