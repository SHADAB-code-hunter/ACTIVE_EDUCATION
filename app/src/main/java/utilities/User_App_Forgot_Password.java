...
public class User_App_Forgot_Password extends Dialog implements View.OnClickListener {
    ...
    public User_App_Forgot_Password(Activity act) {
        super(act);
        this.act=act;
    }
        ...
        id_login_type.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(!open) {
                    ...
                    }, User_App_Forgot_Password.this.getContext(),str_log_array);
