...
public class NEW_ASYNCH_AN extends AsyncTask<Void, Void,JSONObject> {
    ...
    public void NEW_ASYNCH_AN(JOBJ_LISTENER myComponent, Map<String, String> map, String str_url, String loginApi) {
