...
public class SingleSelectToggleGroup extends ToggleButtonGroup {
    ...
    public void setOnCheckedChangeListener(OnCheckedChangeListener listener,View toggle) {
    ...
    private void notifyCheckedChange(int id) {
        if (mOnCheckedChangeListener != null) {
            mOnCheckedChangeListener.onCheckedChanged(this, id,toggle);
        }
    }

    public interface OnCheckedChangeListener {
        void onCheckedChanged(SingleSelectToggleGroup group, int checkedId, View toggle);
    }
}
