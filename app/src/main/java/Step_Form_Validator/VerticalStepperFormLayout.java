...
public class VerticalStepperFormLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public Postion_Listener_Education_Form pos_lis;
    // Data
    ...
    public void goToStep(int stepNumber, boolean restoration) {
        Log.d("stepnumber",""+stepNumber);
       // if(pos_lis!=null)
        this.pos_lis.on_postion_completed(stepNumber);
     ...
     *
     * @deprecated use {@link Builder#newInstance(VerticalStepperFormLayout, String[], VerticalStepperForm, Activity,Postion_Listener_Education_Form pos_lis)} instead like this:
     * <blockquote><pre>
    ...
    public void initialiseVerticalStepperForm(String[] stepsTitles,
        ...
        this.stepTitleTextColor = Color.rgb(255, 255, 255);
    ...
    public void initialiseVerticalStepperForm(String[] stepsTitles,
                                              ...
                                              VerticalStepperForm verticalStepperForm,
                                              Activity activity,
                                              Postion_Listener_Education_Form pos_lis) {
    ...
    protected void initStepperForm(String[] stepsTitles, String[] stepsSubtitles) {
        ...
        for (int i = 0; i < numberOfSteps; i++) {
            ...
            stepContentLayouts.add(stepLayout);// add view creating acc to step dynamicaly
        }
    ...
    protected void setUpStep(int stepNumber) {
        ...
        // here we can use switch case for addinfg diff view.
        LinearLayout stepLayout = createStepLayout(stepNumber);
        Log.d("get_position",""+numberOfSteps+" "+stepNumber);
        if (stepNumber < numberOfSteps) {
    ...
    protected void setUpStepLayoutAsConfirmationStepLayout(LinearLayout stepLayout) {
        ...
        confirmationButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                prepareSendingAndSend();// final submit button
            }
        });
    ...
    protected LinearLayout createStepLayout(final int stepNumber) {
        ...
        circle.setBackground(getResources().getDrawable(R.color.trans_grey));

        TextView stepTitle = (TextView) stepLayout.findViewById(R.id.step_title);
        stepTitle.setText(steps.get(stepNumber));
        stepTitle.setTextColor(getResources().getColor(R.color.white));
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("step_number",""+stepNumber);// step number+1 compled ot click number
    ...
    public static class Builder {
        ...
        public static Builder newInstance(VerticalStepperFormLayout stepperLayout,
            ...
            return new Builder(stepperLayout, stepTitles, stepperImplementation, activity,pos_lis);
        }
